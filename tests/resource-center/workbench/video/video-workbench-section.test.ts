...
assert.ok(sectionContent.includes('const paginationPages = computed(() =>'))
...
assert.ok(sectionContent.includes('class="video-management__pagination-summary"'))
assert.ok(sectionContent.includes('class="video-management__pagination-controls"'))
assert.ok(sectionContent.includes('class="video-management__page-button"'))
assert.ok(sectionContent.includes('viewModel.pagination.from'))
assert.ok(sectionContent.includes('viewModel.pagination.to'))
assert.ok(sectionContent.includes('viewModel.pagination.total'))
assert.ok(sectionContent.includes('viewModel.pagination.hasPrev'))
assert.ok(sectionContent.includes('viewModel.pagination.hasNext'))
